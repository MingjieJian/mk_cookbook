...
一般来说，LDR是对温度变化敏感的谱线深度比上对温度变化不敏感的谱线深度；这样做是防止出现对温度变化敏感的谱线深度很小，作为分母时使得LDR的值非常大的情况。
...
$$ T_\mathrm{eff} = -4196.5 \log{\mathrm{LDR_{16}}}+3227.0 \tag{LDR-16}$$
$$ T_\mathrm{eff} = -3447.3 \log{\mathrm{LDR_{16}}}+3644.3 \tag{LDR-17}$$

其中，

$$ \mathrm{LDR_{16}} = \frac{d_{10753.004}}{d_{10727.406}}, \mathrm{LDR_{17}} = \frac{d_{10818.274}}{d_{10843.858}} $$
