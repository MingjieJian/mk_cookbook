...
$$ EW = \sum_i (1-f_i) * \Del\lambda $$

上下限将谱线包围起来即可。

````{admonition} 例
请根据下表，测量上图中阴影部分橙色谱线的中心波长、深度、半高全宽以及等值宽度。
|   wavelength |     flux |   wavelength |     flux |   wavelength |     flux |
|:-------------:|:---------:|:-------------:|:---------:|:-------------:|:---------:|
|      10749.0 | 0.998005 |      10750.0 | 0.944024 |      10751.0 | 0.977616 |
|      10749.1 | 0.996354 |      10750.1 | 0.870029 |      10751.1 | 0.991015 |
|      10749.2 | 0.993807 |      10750.2 | 0.754    |      10751.2 | 0.994925 |
|      10749.3 | 0.991308 |      10750.3 | 0.626307 |      10751.3 | 0.996287 |
|      10749.4 | 0.990315 |      10750.4 | 0.540209 |      10751.4 | 0.997125 |
|      10749.5 | 0.99123  |      10750.5 | 0.537629 |      10751.5 | 0.997699 |
|      10749.6 | 0.99285  |      10750.6 | 0.619886 |      10751.6 | 0.998118 |
|      10749.7 | 0.99352  |      10750.7 | 0.746747 |      10751.7 | 0.99843  |
|      10749.8 | 0.99093  |      10750.8 | 0.86457  |      10751.8 | 0.998667 |
|      10749.9 | 0.978728 |      10750.9 | 0.94108  |      10751.9 | 0.99885  |
...
### 谱线有什么样的行为？
- 强度随有效温度的变化而变化：原子激发与电离的平衡 - [玻尔兹曼](http://www.phys.ufl.edu/~meisel/Boltzmann.pdf)与[萨哈分布](https://www.astro.princeton.edu/~gk/A403/ioniz.pdf)
    - 参见[STU12](STU_12)的内容。
    - 结论：温度低的时候，没有足够的原子用于吸收光；温度高的时候，原子又被电离了。
- 宽度与原子热运动速度等有关
- 强度与金属丰度（可用铁丰度代替）成正比：吸收原理（整条谱线）与生长曲线

这里着重说一下最后一点。
在固定的有效温度下，如果我们将一条谱线的等值宽度与金属丰度画在一张图上，那么它将会是这样的：
...
### 有效温度的测量：谱线深度比(Line-depth ratio; LDR)
...
:align: center
```
<p style="text-align:center;">图7 谱线深度随温度变化；来自Gray & Johanson (1991) 图1</p>
...
:align: center
```
<p style="text-align:center;">图8 LDR与有效温度的关系；来自Jian et al. (2020) 图5</p>


你可能会问：谱线深度不仅和有效温度有关，还和元素丰度有关；怎么消除元素丰度的影响 ？
...
答案：我们在例中已经得出了这条谱线的等值宽度为0.269Å，对应到纵轴为$\log{0.269}=-0.57$，所以贵元素丰度$\mathrm{[Si/H]}\sim 0$.
````
...
|LDR编号|谱线1波长|谱线1元素|谱线2波长|谱线2元素|关系式|
|:---:|:---:|:---:|:---:|:---:|:---:|
|16|10753.004|Fe I|10727.406|Si I|$-4196.5 \log{\mathrm{LDR}}+3227.0$|
|17|10818.274|Fe I|10843.858|Si I|$-3447.3 \log{\mathrm{LDR}}+3644.3$|

|谱线波长|谱线深度|等值宽度|
|:---:|:---:|:---:|
|10727.406|0.395686|0.37993101999876394|
|10753.004|0.090746|0.033622399999873|
|10818.274|0.074914|0.039538399999861806|
|10843.858|0.36653|0.29491985999900017|


1) 请在光谱中证认出这4条线
2) 测量这4条线的谱线深度
3) 根据2)中的谱线深度计算这颗恒星的有效温度
